...
import edu.unicen.exa.tudai.prog3.gentilmendoza.util.*;
import edu.unicen.exa.tudai.prog3.gentilmendoza.collections.*;
...
//
//
//		System.out.println(">>>>>>>>>>>>>>>>>>>>>>>  Prubas sobre m�todos del arbol <<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
//
//		Tree tree = new Tree();
//
//		System.out.println("--------->>La raiz es " + tree.getRootValue() );
...
//		System.out.println("--------->>La raiz es " + tree.getRootValue() );
//
//		System.out.println("--------->>M�ximo elemento del �rbol " + tree.getMaxElem() );
//
//		System.out.println("--------->>M�nimo elemento del �rbol " + tree.getMinElem() );
//
//		System.out.println("--------->>Cantidad de elementos en el �rbol " + tree.size() );
//
